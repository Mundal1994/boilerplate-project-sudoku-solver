...
suite('Unit Tests', () => {
    const errorLen = 'Expected puzzle to be 81 characters long';
    const errorInvalidChar = 'Invalid characters in puzzle';
    ...
    test('puzzle string with invalid characters (not 1-9 or .)', function(){
        assert.equal(solver.validate('1.5..2.84..63.12.7.2..5.....90.1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.'), errorInvalidChar);
        assert.equal(solver.validate('5..91372.3...8.5.9.9.25..8_68.47.23...95..46.7.4.....5.2.......4..8916..85.72...3'), errorInvalidChar);
        assert.equal(solver.validate('..839.7.575.....964.M1.......16.29846.9.312.7..754.....62..5.78.8...3.2...492...1'), errorInvalidChar);
        assert.equal(solver.validate('.7.89.....5....3.4.2..4..l.5689..472...6.....1.7.5.63873.1.2.8.6..47.1..2.9.387.6'), errorInvalidChar);
        assert.equal(solver.validate('82..4..6...16..89...98315.749.157.............S3..4...96.415..81..7632..3...28.51'), errorInvalidChar);
    });
    test('puzzle string that is not 81 characters in length', function(){
        assert.equal(solver.validate('1.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37'), errorLen);
        assert.equal(solver.validate('5..91372.3...8.5.9.9.25..8.68.47.23...'), errorLen);
        assert.equal(solver.validate(''), errorLen);
        assert.equal(solver.validate('.7.89.....5....3.4.2..4..1.5689..472...6.....1.7.5.63873.1.2.8.6..47.1..2.9.387.6.'), errorLen);
        assert.equal(solver.validate('82..4..6...16..89...98315.749.157.............53..4...96.415..81..7632..3...28.51..............'), errorLen);
    });
    ...
    test('Invalid puzzle strings fail the solver', function(){
        assert.isNotTrue(solver.solve('1.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37'));
        assert.isNotTrue(solver.solve('5..91372.3...8.5.9.9.25..8.68.47.23...'));
        assert.isNotTrue(solver.solve(''));
        assert.isNotTrue(solver.validate('5..91372.3...8.5.9.9.25..8_68.47.23...95..46.7.4.....5.2.......4..8916..85.72...3'));
    });
